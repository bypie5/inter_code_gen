...
dest = './out/hw2'
pkgs = ['./src/main/java/syntax_checker', './src/main/java/inter_code_gen']
...
text_to_remove = ['package syntax_checker;', 'package parser;', 'import syntax_checker.*;', 'import parser.*;', 'package inter_code_gen;']
